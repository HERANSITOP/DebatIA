...
export function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      ...
      const clientId = process.env.NEXT_PUBLIC_AUTH0_CLIENT_ID || "26ngWHmTwxm1l5tGQicm0oBCULXJ0ykL"
      const redirectUri = "http://localhost:3000/callback" // tu ruta de callback
      const audience = process.env.NEXT_PUBLIC_AUTH0_AUDIENCE_TOKEN || "https://dev-2eco3268ivgvoe7i.us.auth0.com/api/v2/" // tu API Identifier

      const url = `${auth0Domain}/authorize?` + new URLSearchParams({
        response_type: "code",
        client_id: clientId,
