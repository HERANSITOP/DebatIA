      ...
      <CardContent>
        <div className="space-y-4">
          <Button
            ...
            disabled={isLoading}
          >
            <svg xmlns="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Logotipo_de_la_Universidad_Nacional_de_Colombia.svg/2048px-Logotipo_de_la_Universidad_Nacional_de_Colombia.svg.png" viewBox="0 0 48 48" className="w-5 h-5">
